...
| **US-02** | Navegación entre secciones | Como administrador de un hospedaje, quiero desplazarme fácilmente entre las secciones de la página, para encontrar rápidamente la información que necesito | **Escenario 1: Opciones de navegación**<br><br>Dado que el administrador ingresa a la landing page<br><br>Cuando se carga la página<br><br>Entonces debe visualizar una barra de navegación horizontal con las secciones de inicio, funcionalidades, planes, contacto e ingreso<br><br>**Escenario 2: Redirección automática de secciones**<br><br>Dado que el administrador se encuentra en la landing page<br><br>Cuando selecciona una opción del menú<br><br>Entonces debe dirigirse a la sección correspondiente<br><br> | **EP-01** |
| **US-03** | Información sobre funcionalidades | Como administrador de un hospedaje, quiero conocer las funcionalidades que ofrece Senit, para evaluar si es útil para las necesidades del hospedaje | **Escenario 1: Revisión de funcionalidades**<br><br>Dado que el administrador revisa la sección de funcionalidades<br><br>Cuando termina de leer el contenido<br><br>Entonces debe comprender que Senit mejora la administración del hospedaje al permitir gestionar reservas, habitaciones, limpieza, personal y facturación<br><br> | **EP-01** |
| **US-04** | Planes de suscripción | Como administrador de un hospedaje, quiero revisar los planes disponibles, para identificar cuál se ajusta mejor a mi hospedaje | **Escenario 1: Visualización de los planes disponibles**<br><br>Dado que el administrador se encuentra en la sección de planes de suscripción<br><br>Cuando visualiza los planes disponibles<br><br>Entonces debe poder comparar fácilmente lo que ofrece el plan básico, pro y enterprise<br><br>**Escenario 2: Selección del plan más adecuado**<br><br>Dado que el administrador ha revisado los planes de suscripción<br><br>Cuando elige la suscripción que desea adquirir<br><br>Entonces se le redirecciona a la ventana de ingreso<br><br> | **EP-01** |
| **US-05** | Sección de contacto | Como administrador de un hospedaje, quiero encontrar un formulario de contacto, para poder solicitar más información o una demostración del servicio | **Escenario 1: Acceso al formulario de contacto**<br><br>Dado que el administrador se encuentra en la sección de contacto<br><br>Cuando visualiza el contenido<br><br>Entonces debe encontrar un formulario con los campos necesarios para poder enviar su mensaje<br><br>**Escenario 2: Envío correcto del formulario**<br><br>Dado que el administrador completa el formulario<br><br>Cuando pulsa el botón de enviar<br><br>Entonces debe mostrarse un mensaje de confirmación de envío<br><br>**Escenario 3: Envío incorrecto del formulario**<br><br>Dado que el administrador no completa correctamente el formulario<br><br>Cuando pulsa el botón de enviar<br><br>Entonces se le debe mostrar una alerta que le indique los campos que no ingresó correctamente<br><br> | **EP-01** |
...
<img src="/assets/SSENIT_Style Guideline.webp" alt="SENIT_Style Guideline" width="auto" height="180"/>
