  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <strong>AV 2:</strong> Durante esta etapa participé activamente en la coordinación y desarrollo de distintas actividades del proyecto, colaborando con mis compañeros en la integración de los avances del Sprint 3. Contribuí realizando una de las entrevistas del segmento objetivo y apoyando en el análisis de los resultados obtenidos para identificar necesidades y oportunidades de mejora del producto. Asimismo, participé en la evaluación heurística de la aplicación, proponiendo observaciones y recomendaciones relacionadas con la experiencia de usuario, la navegación y la claridad de la interfaz. Además, brindé apoyo en algunas tareas del backend para complementar el desarrollo de la solución, manteniendo una comunicación constante con el equipo para resolver dudas, compartir avances y contribuir a la toma de decisiones de manera colaborativa.<br>
        <br>
        <br>
    ...
    <tr>
      ...
      <td>
        ...
        <strong>AV 2:</strong> En este avance organicé mis actividades de acuerdo con los objetivos establecidos para el Sprint 3, distribuyendo mi tiempo entre la realización de entrevistas, la evaluación heurística de la aplicación y el apoyo en tareas de desarrollo backend. Manteniendo una comunicación constante con mis compañeros mediante WhatsApp, compartí avances, recibí retroalimentación y colaboré en la corrección de observaciones identificadas durante las validaciones del sistema. Esto permitió que mi trabajo se integrara adecuadamente con el de los demás integrantes, contribuyendo al cumplimiento de las metas planteadas y al desarrollo ordenado del proyecto.
        <br>
        <br>
        <strong>- Lozano Leon, Richard Enrique:</strong><br>
