<div align="center">
  ...
  <p>
    <br>
    <strong>Nombre del Startup:</strong> SENIT
    <br><br>
    <strong>Nombre del Producto:</strong> SENIT
    <br><br>
    <strong>Integrantes:</strong>
    <br><br>
    Danitza Ivonne Heredia Hoyos - U201910803
    <br><br>
    Edgar Alexander Mauricio Montes Zamora - U20241E126
    <br><br>
    Richard Enrique Lozano Leon - U20241D990
    <br><br>
    Anghelo Faustino Hurtado - U20241B331
    <br><br>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        - Richard Enrique Lozano Leon (U20241D990)<br>
      ...
      <td>
        ...
        - Avance del Capítulo V: Product Implementation, Validation &amp; Deployment hasta el Sprint 1<br>
    ...
    <tr>
      ...
      <td>
        ...
        - Avance del Capítulo V: Product Implementation, Validation &amp; Deployment hasta el Sprint 2<br>
      </td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <strong>AV 2:</strong> Durante esta etapa participé en la realización de entrevistas a usuarios y en la evaluación heurística de la aplicación para identificar oportunidades de mejora en la experiencia de usuario. Además, apoyé en algunas tareas del backend y mantuve una comunicación constante con el equipo para coordinar actividades y compartir avances.<br>
        <strong>TB2:</strong> Durante esta etapa final participé en la revisión y consolidación técnica del backend y frontend de Senit, apoyando al equipo en la verificación de que las funcionalidades implementadas respondieran a los objetivos del Sprint 4. Asimismo, mantuve comunicación constante con mis compañeros para coordinar las pruebas de registro e inicio de sesión con cuentas nuevas, revisar la integración de la Web Application con el API y validar la implementación de autenticación mediante JSON Web Token. También contribuí a que las correcciones realizadas a partir de las entrevistas de validación y la evaluación heurística, como la mejora visual de los estados de habitaciones y la validación del formulario de reservas, se comprendieran como decisiones técnicas y de experiencia de usuario tomadas en conjunto. De esta manera, aporté al liderazgo compartido del equipo, colaborando en la toma de decisiones y en el cierre ordenado del proyecto.
        <br>
        <br>
        ...
        <strong>TB2:</strong> Durante esta etapa final participé en la coordinación y revisión de los avances correspondientes al Sprint 4, apoyando al equipo en la organización de evidencias, la integración de información del frontend y backend, y la coherencia entre lo desarrollado y lo documentado en el informe. Además, mantuve comunicación con mis compañeros para resolver dudas, ordenar pendientes y revisar que las mejoras realizadas a partir de las entrevistas de validación y la evaluación heurística se reflejen adecuadamente en la entrega. De esta manera, contribuí al liderazgo compartido del equipo, promoviendo una toma de decisiones conjunta y un cierre más ordenado del proyecto.
        <br>
        <br>
    ...
    <tr>
      ...
      <td> 
        ...
        <strong>TB:</strong> En esta etapa mantuve una participación constante en las actividades grupales, organizando mis tiempos para cumplir con las responsabilidades acordadas y adaptándome a los cambios y correcciones necesarios durante el desarrollo del proyecto. Además, procuré mantener una comunicación respetuosa y abierta con el equipo, compartiendo avances y escuchando sugerencias, lo que ayudó a fortalecer un entorno de trabajo colaborativo y orientado al cumplimiento de los objetivos comunes.<br>
        <strong>AV 2:</strong> Organicé mis actividades para cumplir con la realización de entrevistas, el análisis heurístico y el apoyo en el desarrollo del backend. Asimismo, compartí mis avances con el equipo, recibí retroalimentación y colaboré en las correcciones necesarias para contribuir al cumplimiento de los objetivos del Sprint 3.<br>
        <strong>TB2:</strong> En esta entrega organicé mis actividades en función de los objetivos finales del Sprint 4, priorizando la revisión de funcionalidades del backend, la integración con el frontend y la validación de los principales flujos del sistema. Para contribuir al cumplimiento de la entrega final, coordiné con el equipo las pruebas de creación de cuentas, inicio de sesión y uso de las funcionalidades principales, considerando que algunas operaciones podían tardar por el despliegue del servicio, pero verificando que los procesos se completaran correctamente. Además, participé en la revisión de observaciones obtenidas en las entrevistas de validación y evaluaciones heurísticas, colaborando en la planificación de mejoras relacionadas con la diferenciación visual de estados de habitaciones y la prevención de datos incompletos en reservas. Esto permitió fortalecer un ambiente de trabajo colaborativo, mantener una planificación orientada a metas y contribuir al cumplimiento de los objetivos establecidos para el cierre del proyecto.
        <br>
        <br>
        <strong>- Lozano Leon, Richard Enrique:</strong><br>
        ...
        <strong>TB2:</strong> En esta etapa organicé mi participación en función de los objetivos finales del Sprint 4, priorizando la revisión del informe, las evidencias de ejecución, despliegue y colaboración, así como la alineación de las secciones trabajadas con los avances reales del producto. También mantuve una actitud colaborativa al comunicarme con el equipo, adaptarme a los cambios solicitados y apoyar en la corrección de observaciones relacionadas con la versión final de Senit. Esto me permitió contribuir a un entorno de trabajo más ordenado, donde las tareas se planificaron de forma progresiva y se orientaron al cumplimiento de la entrega final.
        <br>
        <br>
        <strong>- Faustino Hurtado, Anghelo:</strong><br>
...
| **US-04** | Planes de suscripción | Como visitante del segmento de administración, quiero revisar los planes disponibles, para identificar cuál se ajusta mejor a mi hospedaje | **Escenario 1: Visualización de los planes disponibles**<br><br>Dado que el administrador se encuentra en la sección de planes de suscripción<br><br>Cuando visualiza los planes disponibles<br><br>Entonces debe poder comparar fácilmente lo que ofrece el plan básico, pro y enterprise<br><br>**Escenario 2: Selección del plan más adecuado**<br><br>Dado que el administrador ha revisado los planes de suscripción<br><br>Cuando elige la suscripción que desea adquirir<br><br>Entonces se le redirecciona a la ventana de ingreso<br><br> | **EP-01** |
| **US-05** | Sección de contacto | Como visitante del segmento de administración, quiero encontrar un formulario de contacto, para poder solicitar más información o una demostración del servicio | **Escenario 1: Acceso al formulario de contacto**<br><br>Dado que el administrador se encuentra en la sección de contacto<br><br>Cuando visualiza el contenido<br><br>Entonces debe encontrar un formulario con los campos necesarios para poder enviar su mensaje<br><br>**Escenario 2: Envío correcto del formulario**<br><br>Dado que el administrador completa el formulario<br><br>Cuando pulsa el botón de enviar<br><br>Entonces debe mostrarse un mensaje de confirmación de envío<br><br>**Escenario 3: Envío incorrecto del formulario**<br><br>Dado que el administrador no completa correctamente el formulario<br><br>Cuando pulsa el botón de enviar<br><br>Entonces se le debe mostrar una alerta que le indique los campos que no ingresó correctamente<br><br> | **EP-01** |
